...
Start with [memory-bank/demand.md](memory-bank/demand.md) and [memory-bank/rules.md](memory-bank/rules.md). Use [memory-bank/progress.md](memory-bank/progress.md), [memory-bank/questions.md](memory-bank/questions.md), and [memory-bank/summsry.md](memory-bank/summsry.md) to track work as you go.
...
When you complete a task, update [memory-bank/progress.md](memory-bank/progress.md) and add a short recap to [memory-bank/summsry.md](memory-bank/summsry.md).
